...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::GLSL()
{
	...
	if (!inited)
	{
		static const char* const keywords[] = {
			...
			"signed", "sizeof", "static", "struct", "switch", "typedef", "union", "unsigned", "void", "volatile", "while", "_Alignas", "_Alignof", "_Atomic", "_Bool", "_Complex", "_Generic", "_Imaginary","in",
			"_Noreturn", "_Static_assert", "_Thread_local","sampler2D","uniform","out","vec4","vec2",
			"vec3","mat4"
		};
		for (auto& k : keywords)
			langDef.mKeywords.insert(k);
