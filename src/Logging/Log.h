...
namespace TmingEngine
{
	...
	public:
		...
		// VECTORS
		static void Write(const Vector2& vector, LogType type);
		static void Write(const Vector3& vector, LogType type);
		static void Write(const Vector4& vector, LogType type);

		// QUATERNION
		static void Write(const Quaternion& quaternion, LogType type);
